	...
	<div id="ButtonDiv">
		...
		<table border="0" cellspacing="0" cellpadding="0" class="bottonlist">
			<tr>
				...
				<td class="ButtonTd">
					<a id="new" href="javascript:void(0);" class="ButtonAll bottonAdd png">原料新增</a>
				</td>
...
<script type="text/javascript">
	...
	var PageClick = function (pageclickednumber) {
		...
		$("#size").val(pagenum);
		document.getElementById("vform").action="<c:url value='/admin/rawMaterial/in/list'/>";
	...
	$(function(){
		...
		$("#batchDel").click(function() {
			...
			if (confirm("确定要删除吗？")) {
				$.ajax({
					url: "<c:url value='/admin/rawMaterial/in/del'/>",
		    		data: {
		    			ids : ids
		    		},
		    		type: "POST",
    ...
    $("#new").click(function() {
        ...
        diag.Width = 680;
        diag.Height = 350;
        diag.URL = '<c:url value="/admin/rawMaterial/in/new"/>';
        diag.Title = "新增";
    ...
    function view(id) {
    	...
    	diag.Width = 700;
    	diag.Height = 250;
    	diag.URL = '<c:url value="/admin/rawMaterial/in/view-' + id + '"/>';
    	diag.Title = "浏览";
    	diag.CancelEvent = function () {
    		diag.close();
    	};
