...
<div id="ButtonDiv">
	...
	<div class="info">原料：${rawMaterial.name }（规格：${rawMaterial.specification }）&nbsp;&nbsp;单位：${rawMaterial.units.toString() }&nbsp;&nbsp;进货数量合计：${sum.nums }&nbsp;&nbsp;金额合计（￥）：${sum.sums }</div>
</div>
<div class="ListTable">
...
var PageClick = function (pageclickednumber) {
	...
	$("#size").val(pagenum);
	document.getElementById("vform").action="<c:url value='/admin/repertory/rawMaterial/inView-${rawMaterialId }'/>";
