 ...
 */
@Controller
@RequestMapping("/admin/information/rawMaterial")
public class RawMaterialInfoController {
	...
	public String list(String name, Boolean enabled, Integer page, Integer size, Model model) {
		...
		return "information/rawMaterial/list";
	}
	...
	public String New() {
		return "information/rawMaterial/new";
	}
	...
	public String view(@PathVariable String id, Model model) {
		...
		return "information/rawMaterial/view";
	}
